<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="1-comprasEjercicios.aspx.cs" Inherits="Supervisor._1_comprasEjercicios" %>
...
<body>
    <form id="form1" runat="server">   
        <div>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Explicacion">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:CheckBox ID="CheckBoxExplicacion" runat="server" Enabled="false" Checked='<%#Eval("explicacion") %>' />
                    ...
                    <asp:TemplateField HeaderText="Ejercicio">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:CheckBox ID="CheckBoxEjercicio" runat="server" Enabled="false" Checked='<%#Eval("ejercicio") %>' />

                        </ItemTemplate>

                    </asp:TemplateField>
                    <asp:BoundField ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" DataField="venvimiento" HeaderText="Vencimiento" />
            ...
            <br />
            Panel 2<br />
            <asp:GridView ID="GridView_Supervisor" runat="server" OnSelectedIndexChanged="Identificador_Supervisor" DataKeyNames="ID_CompraEjercicioExplicaicones" AutoGenerateColumns="false">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Administrador">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="LinkBtnSupervisor" runat="server" CommandName="Select" CommandArgument="<%# ((GridViewRow)Container).RowIndex %>"><%#Eval("id_CompraEjercicioExplicaicones") %></asp:LinkButton>
            ...
            <div id="Formulario_Supervisor" runat="server" visible="false">
                ...
                <div>
                    ...
                    <asp:CheckBox ID="ejercicioSolucion_Supervisor" Width="100%" runat="server"></asp:CheckBox>
                </div>
                <div>
                    <label>Explicaicon:</label>
                    <asp:CheckBox ID="ejercicioExplicacion_Supervisor" Width="100%" runat="server"></asp:CheckBox>
                </div>
                <div>
            ...
            Panel 3<br />
            <br />
            <asp:GridView ID="GridView_Dios" runat="server" OnSelectedIndexChanged="Identificador_Dios" DataKeyNames="ID_CompraEjercicioExplicaicones" AutoGenerateColumns="false">
            ...
            <div id="Formulario_Dios" runat="server" visible="false">
                ...
                <div>
                    <label>Solucion:</label>
                    <asp:CheckBox ID="ejercicioSolucion_Dios" Width="100%" runat="server"></asp:CheckBox>
                </div>
                <div>
                    <label>Explicaicon:</label>
                    <asp:CheckBox ID="ejercicioExplicacion_Dios" Width="100%" runat="server"></asp:CheckBox>
                </div>                
                <div>
                    <label>Usuario:</label>
